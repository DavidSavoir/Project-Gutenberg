...
#Original: title_search = re.compile(r'(title:\s*)(?P<title>.*)', re.IGNORECASE)
#First Attempt: title_search = re.compile(r'(title:\s*)(?P<title>.*)', re.IGNORECASE, re.MULTILINE)
title_search = re.compile(r'(title:.*Author$)(?P<title>.*)', re.IGNORECASE, re.MULTILINE)
#make it add the string until the start of author, ignoring any white spaces
